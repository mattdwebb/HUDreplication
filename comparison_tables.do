...
/*-------------------------------------*/
/* Table 5: Advertised home availability */
/*-------------------------------------*/

load_cleaned_data "adsprocessed_correct_cities.dta" "adsprocessed_correct_cities"
...
/*-------------------------------------*/
/* Table 6: Share white recommended home */
/*-------------------------------------*/
...
/*-------------------------------------*/
/* Table 7: White high-income share */
/*-------------------------------------*/
...
/*-------------------------------------*/
/* Table 8: School quality & poverty rate */
/*-------------------------------------*/
...
/*-------------------------------------*/
/* Table 9: Neighborhood density (sfcount) */
/*-------------------------------------*/
...
gen condition_1 = 1
gen condition_2 = 0
replace condition_2 = 1 if kids_x == 1 & tsex_x_x == 0
...
/*-------------------------------------*/
/* Table 10A: School quality (mothers) */
/*-------------------------------------*/

load_cleaned_data "HUDprocessed_testscores_correct_cities.dta" "HUDprocessed_testscores_correct_cities"
capture confirm variable kids_x
if !_rc {
    capture confirm variable tsex_x_x
    if !_rc {
        keep if kids_x == 1 & tsex_x_x == 0
    }
    else {
        keep if kids_x == 1
    }
...
/*-------------------------------------*/
/* Table 10B: ACS outcomes (mothers) */
/*-------------------------------------*/
...
/*-------------------------------------*/
/* Table 11: Low poverty indicator */
/*-------------------------------------*/
...
/*-------------------------------------*/
/* Table 14: Sales price */
/*-------------------------------------*/

load_cleaned_data "HUDprocessed_names_correct_cities.dta" "HUDprocessed_names_correct_cities"
