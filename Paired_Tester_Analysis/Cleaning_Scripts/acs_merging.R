...
# Load API keys
api_keys_path <- file.path("Paired_Tester_Analysis", "api_keys.R")
if (!file.exists(api_keys_path)) {
  stop("Missing Paired_Tester_Analysis/api_keys.R. Copy Paired_Tester_Analysis/api_keys_template.R to api_keys.R and add your Census API key.")
}
