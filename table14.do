...
gen transmonth = month(recordingdate_rec)
...
gen transyear = year(recordingdate_rec)
summarize transyear

// Create transmid11 variable
gen transmid11 = 0
replace transmid11 = 1 if recordingdate_rec > mdy(1, 6, 2011)
replace transmid11 = . if missing(recordingdate_rec)
...
local CONTROL_VARS "transmonth transyear"
...
local condition_1 = "salespriceamount_rec>10000 & salespriceamount_rec<10000000 & transmid11 ==1"
local condition_2 = "salespriceamount_rec>10000 & salespriceamount_rec<10000000 & transmid11 ==1"
