...
// NOTE: ofcolor is not required for this table, but generated here anyways to follow the flow of other tables
...
// Clean missing values for variables
global DESVARS "w2012pc_ad b2012pc_ad a2012pc_ad hisp2012pc_ad sequencex monthx sapptamx algncurx aelng1x dpmtexpx agex aleasetpx acarownx elementary_school_score_ad elementary_school_score_rec skill_ad skill_rec logadprice lnmincome_rec medincome_ad kidsx tsexxx medincome_rec "
...
// Generate log of median income in reccomended neighbourhood
...
local dependent_var_1 = "lnmincome_rec"
local dependent_var_2 = "lnmincome_rec"
...
local control_var_1 = "medincome_ad"
local control_var_2 = "medincome_ad"
...
forvalues d = 1/2 {
    ...
    using "${OUTPUT}/table12_dep_var_`d'_categories.tex", ///
    replace booktabs label ///
    mgroups("Original Data" "Updated City Name Only" "Correct Race Only" "Updated City Name \& Correct Race",pattern(1 1 1 1) ///
    prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) ///
    title(Neighbourhood Attributes as `dependent_var_`d'', Clustered at trial) ///
    ...
    esttab `cols_for_depvar_`d'_categories' ///
    using "${OUTPUT}/table12_dep_var_`d'_categories.csv", ///
    replace csv label ///
    mgroups("Original Data" "Updated City Name Only" "Correct Race Only" "Updated City Name & Correct Race", pattern(1 1 1 1)) ///
    se star(* 0.10 ** 0.05 *** 0.01) ///
    stats(N r2_a, ///
